                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <nav aria-label="breadcrumb" style="margin-top: 0px;">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item active" aria-current="page"><a href="sa_accounts.php"><u>Home</u></a></li>
                                <li class="breadcrumb-item active" aria-current="page"><a href="sa_accounts_reportview.php?">Banned Accounts   
                                    <small>
                            ...
                            <div class="panel panel-default">
                                ...
                                <table id="employee_data" class="table table-striped table-bordered">  
                                  ...
                                  { 
                                        ...
                                        if ($status == 1) $strStatus="<a href=sa_accounts.php?userIDD=".$row['id'].">Activate User</a>"; 
