...
$result = mysqli_query($connection, $query);
 ...
 <?php
$query = "SELECT *,count(*) FROM tbl_report GROUP BY seller_name";
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation" >
                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                <a href="sa_concern.php" class="active" style="color: #64ca87;"><i class="fa fa-comments" aria-hidden="true"></i></i>&nbsp; 
                                User Concerns 
                            </a>
                            </li>
             ...
             <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Concerns</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                        ...
                        <div class="col-lg-12">
                          <h1 class="page-header">User Reports</h1>
                           <nav aria-label="breadcrumb" style="margin-top: 0px;">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item active" aria-current="page"><a href="sa_concern.php"><u>Home</u></a></li>
                                <li class="breadcrumb-item active" aria-current="page"><a href="sa_concern_warning.php?">Warning Accounts <small>
                                    <span class="badge badge-primary" style="background-color: #64ca87;"> 
                                     <?php
                                        $con=mysqli_connect('localhost','root','','pick_a_plant');
                                        $sql="SELECT count(*) AS total FROM tbl_register WHERE status3='1' and u_type='Seller'";
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><a href="sa_concern_ban.php?">Banned Accounts  

                                    <small>
                                    <span class="badge badge-primary" style="background-color: #64ca87;"> 
                                     <?php
                                        $con=mysqli_connect('localhost','root','','pick_a_plant');
                                        $sql="SELECT count(*) AS total FROM tbl_register WHERE status='1' and u_type='Seller'";
                                  ...
                                  { 
                                      ...
                                      $below = "below";
                                        if ($reaches  < 15) {
                                              ...
                                              $strStatus='<a href=sa_concern_report.php?reportview='.$row["seller_id"].'>
                                    ...
                                    echo '  
                                        <tr>  
                                            ...
                                            <td>'. $notif.'</td> 
                                            <td>
                                             <a href=sa_concern_view.php?concernview='.$row["seller_id"].'>
