...
<html lang="en">
                    ...
                    <div class="row">
                        ...
                        <nav aria-label="breadcrumb" style="margin-top: 0px;">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><a href="sa_concern_ban.php?"><u>Banned Accounts</u>  <small>
                                    <span class="badge badge-primary" style="background-color: #64ca87;"> 
                                     <?php
                                        $con=mysqli_connect('localhost','root','','pick_a_plant');
    ...
    if ($status == 1) $strStatus='<a  onclick="javascript:confirmactive($(this));return false;" href=sa_accounts.php?activate='.$row['id'].'>Activate User</a>'; 
