                                  ...
                                  { 
                                       ...
                                       $status3=$row['status3'];
                                        if ($status == 0) $strStatus=
                                            '<a onclick="javascript:confirmreport($(this));return false;" href=sa_accounts.php?userdeacseller='.$row['id'].' >
                                            <span>Deactivate User</span></a>'; 
                                        if ($status == 1) $strStatus=
                                            '<a onclick="javascript:confirmact($(this));return false;" href=sa_accounts.php?useractseller='.$row['id'].' >
                                        <span>Activate User</span></a>'; 


                                         if ($status3 == 0) $strStatus3=
                                            '<a onclick="javascript:warning($(this));return false;" href=sa_accounts.php?warningseller='.$row['id'].' >
                                            <span>Warning Account</span></a>'; 
                                        if ($status3 == 1) $strStatus3=
                                            '<a onclick="javascript:removewarning($(this));return false;" href=sa_accounts.php?removewarningseller='.$row['id'].' >
