                            ...
                            <div class="panel panel-default">
                                ...
                                <table id="superadmin" class="table table-striped table-bordered">  
                                  ...
                                  <?php  
                                    ...
                                    $id = $_GET['concernview'];
                                    $query = "SELECT * FROM tbl_reportbuyer WHERE  buyer_id='$id'";
                                  ...
                                  ?>  
                                    ...
                                    <div class="form-group">
                                      <button type="submit" class="btn btn-default" name="deletereportseller" style="outline: none;"><i class="fa fa-trash fw-fa"></i> Delete Selected</button>
                                      </div>
