...
?>
 ...
 <?php
$query = "SELECT * FROM tbl_register WHERE u_type='Seller'";
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <nav aria-label="breadcrumb" style="margin-top: 0px;">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><a href="sa_concern_warning.php"><u>Warning Accounts</u>
                                <small>
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><a href="sa_concern_ban.php?">Banned Accounts<small>
                                    <span class="badge badge-primary" style="background-color: #64ca87;"> 
                                     <?php
                                        $con=mysqli_connect('localhost','root','','pick_a_plant');
                  ...
                  if ($status3 == 1) $strStatus3='<a onclick="javascript:confirmactive($(this));return false;" href=sa_accounts.php?removewarning='.$row['id'].'>Remove warning Account </a>'; 
