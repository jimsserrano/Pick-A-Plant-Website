                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <nav aria-label="breadcrumb" style="margin-top: 40px;">
                            ...
                            <h1 class="page-header">Update Dictionary</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
   <?php 
  if (isset($_GET['editdic'])) {
          ...
          <input type="hidden" name="id" value="<?php echo $row['id'] ?>"> 
                  ...
                  <div class="form-group">
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                        <input class="form-control input-sm" name="scientific_name" placeholder="Scientific Name" type="text"
                         value="<?php echo $row['scientific_name'] ?>">
                      </div>
                    </div>
                  </div> 
                  ...
                  <div class="form-group">
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                        <input class="form-control input-sm" name="common_name" placeholder="Common Name" type="text" 
                        value="<?php echo $row['common_name'] ?>">
                      </div>
                    </div>
                  </div> 
                  ...
                  <div class="form-group">
                    <div class="col-md-8">
                      ...
                      <div class="col-md-3">
                         <input class="form-control input-sm"  name="plant_type" placeholder="Plant Type" type="text" 
                         value="<?php echo $row['plant_type'] ?>">
                      </div>

                       <label class="col-md-2 control-label">Family:</label>

                      <div class="col-md-3">
                         <input class="form-control input-sm"  step="any" name="family" placeholder="Family" type="text" 
                   ...
                   <div class="form-group">
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                        <input class="form-control input-sm" name="region" placeholder="Region of Origin" type="text" 
                 ...
                 <div class="form-group">
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8"> 
                      <textarea class="form-control input-sm" id="meaning" name="description" cols="1" rows="3" ><?php echo $row['description'] ?>
                      </textarea>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8"> 
                      <textarea class="form-control input-sm" id="trivia" name="trivia" cols="1" rows="3" ><?php echo $row['trivia'] ?></textarea>
                      </div>
                    </div>
                  </div>
                ...
                <div class="form-group">
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                        <button class="btn  btn-primary btn-sm" name="update_plants" type="submit" ><span class="fa fa-save fw-fa"></span> Save</button>
                      </div>
                    </div>
                  </div>
