        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <nav aria-label="breadcrumb" style="margin-top: 0px;">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><a href="sa_seller_warning.php">Warning Accounts
                                <small>
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><a href="sa_seller_ban.php"><u>Banned Accounts</u><small>
                                    <span class="badge badge-primary" style="background-color: #64ca87;"> 
                                     <?php
                                        $con=mysqli_connect('localhost','root','','pick_a_plant');
                  ...
                  if ($status == 0) $strStatus3=
                                            '<a  onclick="javascript:confirmorder($(this));return false;" href=sa_accounts.php?warning='.$row['id'].'>Warning Account</a>'; 
                  if ($status == 1) $strStatus3='<a onclick="javascript:confirmactive($(this));return false;" href=sa_accounts.php?removedeactiveseller='.$row['id'].'>Activate </a>'; 
