...
?>
 ...
 <?php
$query = "SELECT * FROM tbl_register WHERE u_type='Buyer'";
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <nav aria-label="breadcrumb" style="margin-top: 0px;">
                            <ol class="breadcrumb">
                                 <li class="breadcrumb-item active" aria-current="page"><a href="sa_concern_seller.php">Home</a></li>
                                <li class="breadcrumb-item active" aria-current="page"><a href="sa_seller_warning.php"><u>Warning Accounts</u>
                                <small>
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><a href="sa_seller_ban.php">Banned Accounts<small>
                                    <span class="badge badge-primary" style="background-color: #64ca87;"> 
                                     <?php
                                        $con=mysqli_connect('localhost','root','','pick_a_plant');
                  ...
                  if ($status3 == 0) $strStatus3=
                                            '<a  onclick="javascript:confirmorder($(this));return false;" href=sa_accounts.php?warning='.$row['id'].'>Warning Account</a>'; 
                  if ($status3 == 1) $strStatus3='<a onclick="javascript:confirmactive($(this));return false;" href=sa_accounts.php?removewarningseller='.$row['id'].'>Remove warning Account </a>'; 
 ...
 <script type="text/javascript">
       function confirmationDelete(anchor){
        ...
        function confirmactive(anchor) {
            var conf = confirm("Are you sure you want to remove the warning of this Account?");
            if (conf)
                window.location = anchor.attr("href");
        }
</script>
