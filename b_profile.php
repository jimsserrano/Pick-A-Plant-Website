                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb" style="background-color: white; ">
                                    <li class="breadcrumb-item"><a href="b_profile_confirmed.php">
                                        <span id="up">Confirmed <i class="fa fa-thumbs-up" aria-hidden="true"></i></span></a></li>
                                ...
                                for($i=1; $i <= $rowcount; $i++){
                                  ...
                                  $row1=mysqli_fetch_array($result1);
                                            ...
                                            if ($status == 0) {
                                                ...
                                                $cancel =
                                               '<i class="fa fa-minus-circle" aria-hidden="true"></i> <a onclick="javascript:cancelorder($(this));return false;" href=b_profile.php?cancelorder='.$row1['id'].' class="cancel">Cancel</a>';
                                        ...
                                        <tr>
                                           ...
                                           <td>' . $row1['order_id'] . '</td>  
                                            ...
                                            <td>' . $remark . '</td>
                                             ...
                                             <td style="background-color: #ff696e;" width="10%"  class="orderid "  data-target="#' . $row1['id'] . 'issue" 
                                             data-toggle="modal" data-id="105">
                                            <a href="#" title="View list Of ordered products"  class="orderid "  data-target="#myOrdered" style="color: white;">
                                            <i class="fa fa-minus-circle" aria-hidden="true"></i> Cancel order </td>
...
<!-- -=========================FOR CANCEL ORDERS==========================--><!-- -===================================================-->
 ...
 <div class="modal fade" id="<?php echo $row1['id']?>issue" role="dialog">
      ...
      <div class="modal-content" style="text-align: left;">
        ...
        <div class="modal-body">
          <form method="post" enctype="multipart/form-data" action="b_server.php">
                <h4 class="modal-title" style="text-align: center;"><strong>Please select reason<br><br></strong></h4>
          ...
          <div class="row">
            ...
            <div class="col-sm-6">
             ...
             <tr>
              <input type="radio" name="reason" value="Delivery time is too long"> Delivery time is too long<br>
            </tr>

             <tr>
              <input type="radio" name="reason" value="Duplicate order"> Duplicate order<br>
            </tr>
            ...
            <div class="col-sm-6">
            <tr>
              <input type="radio" name="reason" value="Change of mind"> Change of mind<br>
            </tr>

            <tr>
              <input type="radio" name="reason" value="Decided for alternative products"> Decided for alternative products<br>
            </tr>
           ...
           <div class="col-sm-12">
            ...
            <div class="col-sm-12">
               <textarea style="width: 100%; height: 80px; resize: none;" class="form-control" name="other"></textarea>
       ...
       <hr> 
        ...
        <div class="form-group">
          <center><input type="submit" name="ordercancel" value="Confirm" class="btn btn-danger form-control" style="width: 30vh; border-radius: 0px;"></center>
        </div>
