                        ...
                        <small>
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb" style="background-color: white; ">
                                   ...
                                   <!--  <li class="breadcrumb-item"><a href="#"><span id="wish">Wish List</span></a></li> -->
                                </ol>
                            </nav>
                        </small>
                    </div>
                              ...
                              $rowcount=mysqli_num_rows($result1);
                                ...
                                for($i=1; $i <= $rowcount; $i++){
                                  ...
                                  $row1=mysqli_fetch_array($result1);
                                            ...
                                            if ($status == 3) {
                                                $action = '<span style="color: #87CEEB; font-weight: bold;">Delivered</span>'.' <i class="fa fa-check-circle"  style="color: #87CEEB;"></i>';
                                                $remark = "Your order has been delivered, Thank you for ordering ";
