...
//OTHER CANCEL ORDER FOR BUYER MODULE
...
if($other!=''){
    	 ...
    	 $sql="UPDATE tbl_buy SET status='2',  reason2='$other' WHERE id='$id'";
    	 mysqli_query($connection, $sql);
    	 echo ("<script LANGUAGE='JavaScript'>
    window.alert('Cancel Complete');
    window.location.href='b_profile_cancelled.php';
    </script>");
	...
	elseif ($reason!='') {
	 $sql="UPDATE tbl_buy SET status='2',  reason='$reason' WHERE id='$id'";
    	 mysqli_query($connection, $sql);
    	 echo ("<script LANGUAGE='JavaScript'>
    window.alert('Cancel Complete');
    window.location.href='b_profile_cancelled.php';
	...
	{
		echo ("<script LANGUAGE='JavaScript'>
    window.alert('Please indicate your reason for cancellation');
    window.location.href='b_profile.php';
    </script>");
	}
	}
...
elseif (isset($_POST['postcomment'])) {
    ...
    $sql2="UPDATE tbl_product SET ratings='$rating' WHERE id='$id'";
...
if (isset($_POST['submit_password'])) {
    ...
    window.location.href='b_profile2.php';
    </script>");
	}
	else
{
