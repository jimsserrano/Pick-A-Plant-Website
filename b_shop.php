    ...
    function changeStatus($id){
              ...
              <div class="row"  style="text-align: center;">
                ...
                <div class="col-sm-2" id="sale">
                 ...
                 <div class="col-sm-2" id="all">
                   <a href="b_shop.php"><input type="submit" name="" value="All" style="width: 100%; border: none; background-color: transparent; color: white;"></a>
                </div>
        ...
        <!-- Features -->
         <div class="features-container section-container">
          ...
          <?php
                  $query = "SELECT * FROM tbl_product ORDER BY ratings DESC";
