    ...
    function changeStatus($id){
             ...
             <div class="container" style="text-align: center;">
              <div class="row"  style="text-align: center;">
                ...
                <div class="col-sm-2" id="plant">
                   <a href="b_shop_plants.php"><input type="submit" name="" value="Plant" style="width: 100%; border: none; background-color: transparent; "></a>
                </div>
                 ...
                 <div class="col-sm-2" id="fertilizer">
                   <a href="b_shop_fertilizer.php"><input type="submit" name="" value="Fertilizer" style="width: 100%; border: none; background-color: transparent; color: white;"></a>
                </div>
                <div class="col-sm-2" >
        ...
        <!-- Features -->
         <div class="features-container section-container">
          ...
          <?php
                  $query = "SELECT * FROM tbl_product WHERE category='fertilizer'";
