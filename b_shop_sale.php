    ...
    function changeStatus($id){
             ...
             <div class="container" style="text-align: center;">
              <div class="row"  style="text-align: center;">
                ...
                <div class="col-sm-2" id="sale">
                   <a href="b_shop_sale.php"><input type="submit" name="" value="Sale" style="width: 100%; border: none; background-color: transparent;color: white;"></a>
                </div>
        ...
        <!-- Features -->
         <div class="features-container section-container">
          ...
          <?php
                   $query = "SELECT * FROM tbl_product WHERE sale != ' '";
