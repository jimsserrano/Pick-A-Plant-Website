<?php
	...
	elseif($password == $cpassword) {
					$query= "INSERT INTO tbl_register(unique_id,firstname,lastname,username,address,email,phoneno,delivaddress,u_type,password) 
					VALUES('$ran_id','$firstname','$lastname','$username','$address','$email','$phone_number','$address_deliver','$u_type','$hashpassword')";
...
if(isset($_POST['login'])){
   ...
   $row=mysqli_fetch_array($result);
      ...
      if ($row['status3'] == 1 ) {
        ...
        elseif ($row['status'] == 1 ) {
            echo "<script>alert('Your account has been Banned! ');document.location='login.php'</script>";
        }
