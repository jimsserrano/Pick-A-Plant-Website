            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#" class="active" style="color: #64ca87;"><i class="fa fa-shopping-cart" aria-hidden="true"></i>&nbsp; Orders 
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <nav aria-label="breadcrumb" style="margin-top: 40px;">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item active" aria-current="page"><a href="s_order.php"><u>Order</u> </a></li>
                                ...
                                <div class="panel-body">
                                    <div class="table-responsive">
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <td style="width: 50px;"><small><strong>Product ID</strong></small></td>
                                                      ...
                                                      <td style="width: 50px;"><small><strong>Order ID</strong></small></td>
                                            ...
                                            for ($i = 1; $i <= $rowcount; $i++) {
                                                ...
                                                if ($status == 0) {
                                                    ...
                                                    $diable1 =
                                                        ...
                                                        "<a href=s_order.php?userIDD=" . $row1['product_id'] . " class='confirm'>Confirm</a>";
                                                    $order= 
                                                    ' <button class="btn btn-success disconfirm" disabled>Pending</button>';

                                                    $disable1=
                                                    ' 
                                                    <a onclick="confirmorder()" href=s_order.php?userIDD='. $row1['id'].' class="confirm">Confirm</a>
                                                   ';
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="quantity" id="quantity" value="<?php echo $row1['quantity']; ?>">
                                            <input type="hidden" name="stocks" id="stocks" value="<?php echo $row1['stocks']; ?>">
                                            <input type="hidden" name="stocks" id="product_number" value="<?php echo $row1['product_number']; ?>">
                                            ...
                                            <script>
                                                ...
                                                data: {quantity:quantity,stocks:stocks,product_number:product_number},
                                                type: "POST",  
                                                success:confirm("are you sure to confirm this order?")
                                                });
                                                }
                                            </script>
...
<hr>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                <h5><b>Product: </b><?php echo $row1['name']?></h5>
            </div>

            <div class="col-sm-6">
                <h5><b>Product Number: </b><?php echo $row1['product_number']?></h5>
            </div>
        </div>
    </div>
    <thead>
