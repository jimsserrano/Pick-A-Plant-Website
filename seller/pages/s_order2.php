            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#" class="active" style="color: #64ca87;"><i class="fa fa-shopping-cart" aria-hidden="true"></i>&nbsp; Orders</a>
                        </li>
                    ...
                    <div class="col-lg-12">
                        ...
                        <nav aria-label="breadcrumb" style="margin-top: 40px;">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><a href="s_order_confirm.php">Confirm</a></li>
                                <li class="breadcrumb-item active" aria-current="page"><a href="s_order_cancel.php">Cancelled</a></li>
                                        ...
                                        <table id="employee_data" class="table table-striped table-bordered">
                                            ...
                                            for ($i = 1; $i <= $rowcount; $i++) {
                                                ...
                                                if ($status == 0) {
                                                    $action = "Pending";
                                                    $diable1 =
                                                        "<a href=s_order_order.php?userID=" . $row1['id'] . " class='cancel'>Cancel</a>" . " " .
                                                    ...
                                                    $disable1=
                                                    ' <a onclick="javascript:cancelorder($(this));return false;" href=s_order.php?userID='.$row1['id'].' class="cancel">Cancel</a>

                                                    <a onclick="javascript:confirmorder($(this));return false;" href=s_order.php?userIDD='.$row1['id'].' class="confirm">Confirm</a>';
                                            ...
                                            data-target="#' . $row1['id'] . '">' . $row1["order_number"] . '</a></center>' . '</td>    
...
<hr>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-6">
                <h5><b>Order ID: </b><?php echo $row1['order_number']?></h5>
            </div>
        </div>
    </div>
    <thead>
